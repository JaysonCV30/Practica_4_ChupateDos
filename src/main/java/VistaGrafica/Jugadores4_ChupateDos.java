...
public class Jugadores4_ChupateDos extends javax.swing.JFrame {

    public Jugadores4_ChupateDos() {
        init();
    }
    ...
    private void initComponents() {
        ...
        txtJugador4.setBackground(new java.awt.Color(254, 249, 230));
        txtJugador4.setFont(new java.awt.Font("BankGothic Md BT", 1, 28)); // NOI18N
        txtJugador4.setForeground(new java.awt.Color(220, 205, 105));
        txtJugador4.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        txtJugador4.setText("JUGADOR 4");
        txtJugador4.setPreferredSize(new java.awt.Dimension(230, 40));
    ...
    private void txtJugador4MouseEntered(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_txtJugador4MouseEntered
        Border borde = BorderFactory.createLineBorder(new Color(174,165,40),3);
    ...
    private void txtJugador4KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtJugador4KeyTyped
        char caracter = Character.toUpperCase(evt.getKeyChar());
        evt.setKeyChar(caracter);
        if(txtJugador4.getText().length()>= 9)
            evt.consume();
    ...
    private void botonIniciarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_botonIniciarMouseClicked
        ...
        ChupateDos_4Jugadores iniciaJuego = new ChupateDos_4Jugadores(jugador1,jugador2,jugador3,jugador4);
